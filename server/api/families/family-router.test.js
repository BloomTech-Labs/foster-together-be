  ...
  describe(`custom error handling`, () => {
    test('should respond with status 500, a message, and the original thrown error', async () => {
      ...
      expect(JSON.parse(res.text).error).toBe(
        'insert into "families" ("address", "city_state_zip_id", "first_name", "last_name", "phone") values ($1, $2, $3, $4, $5) returning "first_name", "last_name", "email", "phone", "address" - null value in column "email" violates not-null constraint'
      )
    })
  })
})
